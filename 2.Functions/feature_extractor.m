%% FEATURE_EXTRACTOR
%  Function used to extract LBP features
%  INPUT:
%         - file      : the image frame of the face
%         - pos       : the positions of inner canthuses and philtrum
%         - d         : boolean, whether to extract also the depth data
%  OUTPUT:
%         - features  : LBP features extracted for grayscale data
%         - d_features: LBP features extracted for depth data

function [features, d_features] = feature_extractor( file, pos, d, out )
